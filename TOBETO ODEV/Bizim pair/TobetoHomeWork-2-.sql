...
select sum(unit_price*quantity) as Profit from order_details od
inner join orders o on o.order_id = od.order_id
where product_id=10 and 
order_date between '1998-02-01' and '1998-05-31';
...
select company_name,contact_name,address,city,country from customers c where country='Brazil';
